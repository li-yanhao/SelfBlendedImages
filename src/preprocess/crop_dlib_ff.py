...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', dest='dataset', choices=['DeepFakeDetection_original', 'DeepFakeDetection', 'FaceShifter', 'Face2Face',
                        'Deepfakes', 'FaceSwap', 'NeuralTextures', 'Original', 'Celeb-real', 'Celeb-synthesis', 'YouTube-real', 'DFDC', 'DFDCP'])
    ...
    for i in tqdm(range(n_sample)):
        ...
        facecrop(movies_path_list[i], save_path=dataset_path, num_frames=args.num_frames,
